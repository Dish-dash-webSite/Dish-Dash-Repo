...
const Sidebar: React.FC<SidebarProps> = ({ isSidebarOpen, closeSidebar, onMenuItemClick }) => {
    ...
    return (
        <div
            className={`fixed top-0 left-0 h-screen w-64 bg-[#FC8A06] shadow-lg transform transition-transform duration-300 ease-in-out z-50 ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'
                }`}
        >
            <button
